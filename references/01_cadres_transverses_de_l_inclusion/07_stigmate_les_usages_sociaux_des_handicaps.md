...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Goffman, E.** |
| **Année de référence** | **1963** |
...
Analyse du stigmate et de sa gestion. Rappelle qu'une adaptation visible peut désigner l'élève devant le groupe : d'où la préférence pour ce qui peut être proposé à toute la classe.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Goffman, E.* (1963) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Goffman, E.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Analyse du stigmate et de sa gestion. Rappelle qu'une adaptation visible peut désigner l'élève devant le groupe : d'où la préférence pour ce qui peut être proposé à toute la classe. »*
> — Source : Goffman, E. (1963), *Stigmate — les usages sociaux des handicaps*.
