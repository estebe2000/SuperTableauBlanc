...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Rosenthal, R. & Jacobson, L.** |
| **Année de référence** | **1968** |
...
Effet des attentes de l'enseignant sur les résultats des élèves. Contrepoids indispensable à toute différenciation : adapter le chemin sans jamais abaisser le niveau d'attente affiché.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Rosenthal, R. & Jacobson, L.* (1968) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Rosenthal, R. & Jacobson, L.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Effet des attentes de l'enseignant sur les résultats des élèves. Contrepoids indispensable à toute différenciation : adapter le chemin sans jamais abaisser le niveau d'attente affiché. »*
> — Source : Rosenthal, R. & Jacobson, L. (1968), *Pygmalion in the Classroom*.
