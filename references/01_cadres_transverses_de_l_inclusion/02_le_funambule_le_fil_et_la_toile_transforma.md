# Le funambule, le fil et la toile — transformations réciproques du sens du handicap

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Fougeyrollas, P.** |
...
Processus de production du handicap (PPH), modèle québécois qui détaille l'interaction entre facteurs personnels, facteurs environnementaux et habitudes de vie. Prolonge la CIF du côté des obstacles concrets de la situation scolaire.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Fougeyrollas, P.* (2010) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Fougeyrollas, P.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Processus de production du handicap (PPH), modèle québécois qui détaille l'interaction entre facteurs personnels, facteurs environnementaux et habitudes de vie. Prolonge la CIF du côté des obstacles concrets de la situation scolaire. »*
> — Source : Fougeyrollas, P. (2010), *Le funambule, le fil et la toile — transformations réciproques du sens du handicap*.
