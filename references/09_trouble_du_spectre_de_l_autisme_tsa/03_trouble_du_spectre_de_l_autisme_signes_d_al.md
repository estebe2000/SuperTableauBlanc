...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Haute Autorité de Santé (HAS)** |
...
Recommandations de bonne pratique de la HAS, rappel que le repérage et le diagnostic relèvent des professionnels de santé — l'école adapte à partir d'observables, sans diagnostiquer.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Haute Autorité de Santé (HAS)* (2018) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Haute Autorité de Santé (HAS)* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Recommandations de bonne pratique de la HAS, rappel que le repérage et le diagnostic relèvent des professionnels de santé — l'école adapte à partir d'observables, sans diagnostiquer. »*
> — Source : Haute Autorité de Santé (HAS) (2018), *Trouble du spectre de l'autisme : signes d'alerte, repérage, diagnostic et évaluation chez l'enfant et l'adolescent*.
