# Cap École inclusive — plateforme de ressources et de fiches pédagogiques pour les enseignants

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Réseau Canopé — MEN** |
| **Année de référence** | **2024** |
| **Catégorie thématique** | **Trouble du spectre de l'autisme (TSA)** |
| **Champ disciplinaire** | Sciences de l'Éducation, Neurosciences cognitives, Droit & Éthique inclusive |

- **Lien institutionnel / Source** : [https://www.reseau-canope.fr/cap-ecole-inclusive](https://www.reseau-canope.fr/cap-ecole-inclusive)
...
Plateforme ministérielle proposant des fiches pédagogiques par besoin (dont l'autisme), socle des adaptations proposées par le module « Adaptations TSA ».
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Réseau Canopé — MEN* (2024) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Réseau Canopé — MEN* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Plateforme ministérielle proposant des fiches pédagogiques par besoin (dont l'autisme), socle des adaptations proposées par le module « Adaptations TSA ». »*
> — Source : Réseau Canopé — MEN (2024), *Cap École inclusive — plateforme de ressources et de fiches pédagogiques pour les enseignants*.
