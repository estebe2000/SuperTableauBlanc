# Structurer le temps et l'espace pour les élèves à besoins éducatifs particuliers

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Éduscol — Cap École inclusive** |
| **Année de référence** | **2024** |
| **Catégorie thématique** | **Structuration du temps et supports visuels (TEACCH)** |
| **Champ disciplinaire** | Sciences de l'Éducation, Neurosciences cognitives, Droit & Éthique inclusive |

- **Lien institutionnel / Source** : [https://eduscol.education.fr/1247/cap-ecole-inclusive](https://eduscol.education.fr/1247/cap-ecole-inclusive)
...
Ressources institutionnelles sur les emplois du temps visuels et les séquentiels d'activité.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Éduscol — Cap École inclusive* (2024) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Éduscol — Cap École inclusive* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ressources institutionnelles sur les emplois du temps visuels et les séquentiels d'activité. »*
> — Source : Éduscol — Cap École inclusive (2024), *Structurer le temps et l'espace pour les élèves à besoins éducatifs particuliers*.
