...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Dehaene, S.** |
...
Le sens du nombre et le modèle du triple code ; fondements cognitifs des apprentissages numériques.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Dehaene, S.* (2010) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Dehaene, S.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Le sens du nombre et le modèle du triple code ; fondements cognitifs des apprentissages numériques. »*
> — Source : Dehaene, S. (2010), *La Bosse des maths : quinze ans après*.
