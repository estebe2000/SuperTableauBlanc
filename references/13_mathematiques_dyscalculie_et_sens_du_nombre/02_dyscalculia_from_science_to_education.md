...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Butterworth, B.** |
| **Année de référence** | **2019** |
| **Catégorie thématique** | **Mathématiques, dyscalculie et sens du nombre** |
...
Synthèse scientifique sur la dyscalculie développementale et ses implications pédagogiques.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Butterworth, B.* (2019) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Butterworth, B.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Synthèse scientifique sur la dyscalculie développementale et ses implications pédagogiques. »*
> — Source : Butterworth, B. (2019), *Dyscalculia: From Science to Education*.
