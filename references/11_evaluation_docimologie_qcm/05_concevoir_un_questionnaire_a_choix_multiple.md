# Concevoir un questionnaire à choix multiple

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Louvain Learning Lab (UCLouvain)** |
...
- **Lien institutionnel / Source** : [https://cdn.uclouvain.be/groups/cms-editors-lll/Concevoir%20un%20QCM.pdf](https://cdn.uclouvain.be/groups/cms-editors-lll/Concevoir%20un%20QCM.pdf)
...
Guide pratique : seuls les quatre premiers niveaux de Bloom (connaissance, compréhension, application, analyse) sont mobilisables en QCM ; synthèse et création ne le sont pas (p. 10).
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Louvain Learning Lab (UCLouvain)* (2020) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Louvain Learning Lab (UCLouvain)* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Guide pratique : seuls les quatre premiers niveaux de Bloom (connaissance, compréhension, application, analyse) sont mobilisables en QCM ; synthèse et création ne le sont pas (p. 10). »*
> — Source : Louvain Learning Lab (UCLouvain) (2020), *Concevoir un questionnaire à choix multiple*.
