...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Leclercq, D.** |
| **Année de référence** | **1986** |
...
- **Lien institutionnel / Source** : [https://orbi.uliege.be/handle/2268/17835](https://orbi.uliege.be/handle/2268/17835)
...
Ouvrage de référence en docimologie (Bruxelles : Labor) dont sont issues les 20 règles de rédaction des QCM utilisées par le module « Concevoir un QCM ».
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Leclercq, D.* (1986) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Leclercq, D.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ouvrage de référence en docimologie (Bruxelles : Labor) dont sont issues les 20 règles de rédaction des QCM utilisées par le module « Concevoir un QCM ». »*
> — Source : Leclercq, D. (1986), *La conception des Questions à Choix Multiple*.
