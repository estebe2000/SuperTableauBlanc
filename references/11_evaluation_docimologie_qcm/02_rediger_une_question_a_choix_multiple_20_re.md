# Rédiger une question à choix multiple — 20 règles pour rédiger vos QCM

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Castaigne, J.-L.** |
| **Année de référence** | **2020** |
| **Catégorie thématique** | **Évaluation & docimologie (QCM)** |
| **Champ disciplinaire** | Sciences de l'Éducation, Neurosciences cognitives, Droit & Éthique inclusive |

- **Lien institutionnel / Source** : [https://imt.scenari-community.org/carae/aide/co/qcm.html](https://imt.scenari-community.org/carae/aide/co/qcm.html)
...
Synthèse pédagogique des règles de Leclercq, réalisée à l'IMT Atlantique (CARÆ) et mise en ligne par le centre d'appui (« Je rédige une bonne Question à Choix Multiples »). Source directe du module « Rédiger un QCM » ; règles citées au titre du droit de citation (les droits restent à leurs auteurs).
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Castaigne, J.-L.* (2020) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Castaigne, J.-L.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Synthèse pédagogique des règles de Leclercq, réalisée à l'IMT Atlantique (CARÆ) et mise en ligne par le centre d'appui (« Je rédige une bonne Question à Choix Multiples »). Source directe du module « Rédiger un QCM » ; règles citées au titre du droit de citation (les droits restent à leurs auteurs). »*
> — Source : Castaigne, J.-L. (2020), *Rédiger une question à choix multiple — 20 règles pour rédiger vos QCM*.
