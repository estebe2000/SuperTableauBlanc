...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Anderson, L. W. & Krathwohl, D. R.** |
...
Révision de la taxonomie de Bloom (verbes d'action), utilisée pour graduer les questions du QCM de la restitution à l'analyse.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Anderson, L. W. & Krathwohl, D. R.* (2001) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Anderson, L. W. & Krathwohl, D. R.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Révision de la taxonomie de Bloom (verbes d'action), utilisée pour graduer les questions du QCM de la restitution à l'analyse. »*
> — Source : Anderson, L. W. & Krathwohl, D. R. (2001), *A Taxonomy for Learning, Teaching, and Assessing: A Revision of Bloom's Taxonomy*.
