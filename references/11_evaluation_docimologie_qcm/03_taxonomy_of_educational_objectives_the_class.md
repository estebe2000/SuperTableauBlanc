...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Bloom, B. S. (dir.)** |
| **Année de référence** | **1956** |
...
Taxonomie fondatrice des objectifs d'apprentissage, qui structure les questions du QCM par niveaux cognitifs (mémoriser, comprendre, appliquer, analyser…).
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Bloom, B. S. (dir.)* (1956) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Bloom, B. S. (dir.)* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Taxonomie fondatrice des objectifs d'apprentissage, qui structure les questions du QCM par niveaux cognitifs (mémoriser, comprendre, appliquer, analyser…). »*
> — Source : Bloom, B. S. (dir.) (1956), *Taxonomy of Educational Objectives: The Classification of Educational Goals*.
