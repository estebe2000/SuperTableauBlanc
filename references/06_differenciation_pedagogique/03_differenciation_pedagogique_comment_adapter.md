# Différenciation pédagogique : comment adapter l'enseignement pour la réussite de tous les élèves — Conférence de consensus

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Cnesco & Ifé/ENS de Lyon** |
| **Année de référence** | **2017** |
| **Catégorie thématique** | **Différenciation pédagogique** |
| **Champ disciplinaire** | Sciences de l'Éducation, Neurosciences cognitives, Droit & Éthique inclusive |

- **Lien institutionnel / Source** : [https://www.cnesco.fr/fr/differenciation-pedagogique/](https://www.cnesco.fr/fr/differenciation-pedagogique/)
...
Conférence de consensus réunissant chercheurs et praticiens, avec recommandations sur les formes efficaces de différenciation pédagogique.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Cnesco & Ifé/ENS de Lyon* (2017) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Cnesco & Ifé/ENS de Lyon* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Conférence de consensus réunissant chercheurs et praticiens, avec recommandations sur les formes efficaces de différenciation pédagogique. »*
> — Source : Cnesco & Ifé/ENS de Lyon (2017), *Différenciation pédagogique : comment adapter l'enseignement pour la réussite de tous les élèves — Conférence de consensus*.
