...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Tomlinson, C. A.** |
...
Ouvrage de référence sur les stratégies de différenciation pédagogique pour les classes hétérogènes.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Tomlinson, C. A.* (2017) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Tomlinson, C. A.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ouvrage de référence sur les stratégies de différenciation pédagogique pour les classes hétérogènes. »*
> — Source : Tomlinson, C. A. (2017), *How to Differentiate Instruction in Academically Diverse Classrooms*.
