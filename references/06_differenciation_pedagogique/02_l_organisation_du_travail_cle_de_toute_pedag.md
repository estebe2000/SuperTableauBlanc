...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Perrenoud, P.** |
...
Analyse des conditions organisationnelles nécessaires à la mise en œuvre de la différenciation pédagogique.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Perrenoud, P.* (2012) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Perrenoud, P.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Analyse des conditions organisationnelles nécessaires à la mise en œuvre de la différenciation pédagogique. »*
> — Source : Perrenoud, P. (2012), *L'organisation du travail, clé de toute pédagogie différenciée*.
