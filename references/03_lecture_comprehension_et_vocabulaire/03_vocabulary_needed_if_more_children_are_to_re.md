# Vocabulary: Needed if More Children Are to Read Well (Reading Psychology, 24)

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Biemiller, A.** |
...
Rôle du vocabulaire dans la réussite scolaire ultérieure et effet cumulatif des écarts de lexique.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Biemiller, A.* (2003) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Biemiller, A.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Rôle du vocabulaire dans la réussite scolaire ultérieure et effet cumulatif des écarts de lexique. »*
> — Source : Biemiller, A. (2003), *Vocabulary: Needed if More Children Are to Read Well (Reading Psychology, 24)*.
