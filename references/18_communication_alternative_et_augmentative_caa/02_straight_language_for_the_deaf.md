...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Fitzgerald, E.** |
...
Origine de la clé de Fitzgerald, code couleur qui range le vocabulaire par fonction dans la phrase (personnes, actions, choses, descriptions, formules sociales, mots de liaison). Devenu le standard des tableaux de communication.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Fitzgerald, E.* (1929) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Fitzgerald, E.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Origine de la clé de Fitzgerald, code couleur qui range le vocabulaire par fonction dans la phrase (personnes, actions, choses, descriptions, formules sociales, mots de liaison). Devenu le standard des tableaux de communication. »*
> — Source : Fitzgerald, E. (1929), *Straight Language for the Deaf*.
