# Communiquer autrement — accompagner les personnes avec des troubles de la parole ou du langage

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Cataix-Nègre, É.** |
...
Ouvrage de référence en français sur la CAA : principes, outils, mise en œuvre auprès des personnes sans langage oral fonctionnel.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Cataix-Nègre, É.* (2017) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Cataix-Nègre, É.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ouvrage de référence en français sur la CAA : principes, outils, mise en œuvre auprès des personnes sans langage oral fonctionnel. »*
> — Source : Cataix-Nègre, É. (2017), *Communiquer autrement — accompagner les personnes avec des troubles de la parole ou du langage*.
