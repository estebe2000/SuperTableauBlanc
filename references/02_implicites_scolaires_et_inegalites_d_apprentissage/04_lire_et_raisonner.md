...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Downing, J. & Fijalkow, J.** |
| **Année de référence** | **1984** |
...
La clarté cognitive : savoir à quoi sert ce que l'on fait est une condition de l'apprentissage, pas un supplément d'explication.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Downing, J. & Fijalkow, J.* (1984) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Downing, J. & Fijalkow, J.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« La clarté cognitive : savoir à quoi sert ce que l'on fait est une condition de l'apprentissage, pas un supplément d'explication. »*
> — Source : Downing, J. & Fijalkow, J. (1984), *Lire et raisonner*.
