# Difficultés d'apprentissage, processus de secondarisation et pratiques enseignantes (Revue française de pédagogie, 148)

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Bautier, É. & Goigoux, R.** |
| **Année de référence** | **2004** |
| **Catégorie thématique** | **Implicites scolaires et inégalités d'apprentissage** |
...
La secondarisation : passer du « faire » au savoir que ce faire permet de construire. Fonde la distinction, demandée par le module, entre ce que l'élève doit FAIRE et ce qu'il doit APPRENDRE en le faisant.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Bautier, É. & Goigoux, R.* (2004) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Bautier, É. & Goigoux, R.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« La secondarisation : passer du « faire » au savoir que ce faire permet de construire. Fonde la distinction, demandée par le module, entre ce que l'élève doit FAIRE et ce qu'il doit APPRENDRE en le faisant. »*
> — Source : Bautier, É. & Goigoux, R. (2004), *Difficultés d'apprentissage, processus de secondarisation et pratiques enseignantes (Revue française de pédagogie, 148)*.
