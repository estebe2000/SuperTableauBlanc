# Principles of Instruction — Research-Based Strategies That All Teachers Should Know (American Educator)

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Rosenshine, B.** |
| **Année de référence** | **2012** |
| **Catégorie thématique** | **Conception Universelle de l'Apprentissage (CUA)** |
...
Étapes de l'enseignement explicite : objectivation, modelage, pratique guidée, pratique autonome (prolonge sa synthèse de 1986). Mobilisé par les modules « Conception CUA » et « Analyse CUA », où cette structuration soutient les fonctions exécutives et l'autorégulation.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Rosenshine, B.* (2012) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Rosenshine, B.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Étapes de l'enseignement explicite : objectivation, modelage, pratique guidée, pratique autonome (prolonge sa synthèse de 1986). Mobilisé par les modules « Conception CUA » et « Analyse CUA », où cette structuration soutient les fonctions exécutives et l'autorégulation. »*
> — Source : Rosenshine, B. (2012), *Principles of Instruction — Research-Based Strategies That All Teachers Should Know (American Educator)*.
