...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Meyer, A., Rose, D.H. & Gordon, D.** |
...
Ouvrage fondateur qui développe la théorie et les applications pratiques de la CUA en contexte scolaire.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Meyer, A., Rose, D.H. & Gordon, D.* (2014) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Meyer, A., Rose, D.H. & Gordon, D.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ouvrage fondateur qui développe la théorie et les applications pratiques de la CUA en contexte scolaire. »*
> — Source : Meyer, A., Rose, D.H. & Gordon, D. (2014), *Universal Design for Learning: Theory and Practice*.
