...
- **Lien institutionnel / Source** : [https://udlguidelines.cast.org/](https://udlguidelines.cast.org/)
...
Cadre de référence international pour la CUA, organisé autour de 3 principes : représentation, action/expression, engagement. C'est cette version qui est détaillée dans les modules « Conception CUA » et « Analyse CUA », en cohérence avec les ressources françaises d'Éduscol et de Primabord.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *CAST* (2018) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *CAST* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
