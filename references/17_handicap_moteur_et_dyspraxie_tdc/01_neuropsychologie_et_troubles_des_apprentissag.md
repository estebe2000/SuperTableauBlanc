...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Mazeau, M. & Pouhet, A.** |
...
Référence sur la dyspraxie / le trouble développemental de la coordination et ses adaptations.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Mazeau, M. & Pouhet, A.* (2014) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Mazeau, M. & Pouhet, A.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Référence sur la dyspraxie / le trouble développemental de la coordination et ses adaptations. »*
> — Source : Mazeau, M. & Pouhet, A. (2014), *Neuropsychologie et troubles des apprentissages chez l'enfant*.
