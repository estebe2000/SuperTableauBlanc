...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Gray, C. & Garand, J.** |
| **Année de référence** | **1993** |
| **Catégorie thématique** | **Scénarios sociaux (Social Stories)** |
...
Article fondateur de la méthode : décrire une situation sociale du point de vue de la personne, plutôt que lui prescrire un comportement.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Gray, C. & Garand, J.* (1993) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Gray, C. & Garand, J.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Article fondateur de la méthode : décrire une situation sociale du point de vue de la personne, plutôt que lui prescrire un comportement. »*
> — Source : Gray, C. & Garand, J. (1993), *Social Stories: Improving responses of students with autism with accurate social information*.
