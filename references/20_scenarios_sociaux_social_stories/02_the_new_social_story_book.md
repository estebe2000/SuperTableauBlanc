...
Règles de rédaction de référence, dont la proportion d'au moins deux phrases descriptives pour une phrase directive.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Gray, C.* (2015) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Gray, C.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Règles de rédaction de référence, dont la proportion d'au moins deux phrases descriptives pour une phrase directive. »*
> — Source : Gray, C. (2015), *The New Social Story Book*.
