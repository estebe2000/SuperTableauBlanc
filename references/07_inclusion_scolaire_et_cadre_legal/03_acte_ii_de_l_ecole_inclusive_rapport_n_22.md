# Acte II de l'école inclusive — Rapport n° 22-23 107B

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **IGÉSR** |
...
- **Lien institutionnel / Source** : [https://www.education.gouv.fr/media/200192/download](https://www.education.gouv.fr/media/200192/download)
...
Rapport de l'inspection générale dressant un bilan de la politique d'école inclusive et formulant des recommandations pour son renforcement.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *IGÉSR* (2023) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *IGÉSR* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Rapport de l'inspection générale dressant un bilan de la politique d'école inclusive et formulant des recommandations pour son renforcement. »*
> — Source : IGÉSR (2023), *Acte II de l'école inclusive — Rapport n° 22-23 107B*.
