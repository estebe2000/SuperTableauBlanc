# Scolariser les élèves aveugles ou malvoyants

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Éduscol / INSEI** |
...
Ressources d'adaptation (agrandissement, braille, description) et de coordination.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Éduscol / INSEI* (2024) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Éduscol / INSEI* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Ressources d'adaptation (agrandissement, braille, description) et de coordination. »*
> — Source : Éduscol / INSEI (2024), *Scolariser les élèves aveugles ou malvoyants*.
