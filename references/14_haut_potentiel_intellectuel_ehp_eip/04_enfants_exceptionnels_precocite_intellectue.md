# Enfants exceptionnels : précocité intellectuelle, haut potentiel et talents

| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Lubart, T. (dir.)** |
...
Synthèse française de référence sur le haut potentiel.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Lubart, T. (dir.)* (2006) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Lubart, T. (dir.)* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Synthèse française de référence sur le haut potentiel. »*
> — Source : Lubart, T. (dir.) (2006), *Enfants exceptionnels : précocité intellectuelle, haut potentiel et talents*.
