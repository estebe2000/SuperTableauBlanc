...
| Métadonnée | Valeur |
| :--- | :--- |
| **Auteur(s) / Institution** | **Renzulli, J. S. & Reis, S. M.** |
...
Modèle de référence de l'enrichissement (triade), centré sur l'approfondissement et le projet plutôt que l'accélération.
...
1. **Modélisation & Fondements scientifiques** :
   - L'approche développée par *Renzulli, J. S. & Reis, S. M.* (2014) constitue un pilier de la compréhension des besoins éducatifs particuliers et des situations de handicap ou d'empêchement d'apprendre.
...
* **Gabarits de prompts CUA (`.agents/skills/prompts-cua`)** : Mobilisation des axiomes de *Renzulli, J. S. & Reis, S. M.* dans les prompts système pour contraindre les sorties des LLM souverains (Albert, Mistral, Ollama).
...
> *« Modèle de référence de l'enrichissement (triade), centré sur l'approfondissement et le projet plutôt que l'accélération. »*
> — Source : Renzulli, J. S. & Reis, S. M. (2014), *The Schoolwide Enrichment Model*.
