...
export function initVision() {
  ...
  generateBtn.addEventListener('click', () => {
    ...
    if (effectiveProvider === 'ilaas') {
      ...
      requestOptions.model = 'mistral-small-3-2-24b-instruct-2506';
      requestOptions.resolvedType = 'openai';
    } else if (effectiveProvider === 'albert' && (!effectiveModel || (!effectiveModel.includes('Mistral') && !effectiveModel.includes('mistral') && !effectiveModel.includes('ministral') && !effectiveModel.includes('ocr')))) {
      requestOptions.model = 'ministral-3-8b-instruct-2512';
    }
