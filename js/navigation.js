export function initNavigation() {
  ...
  function switchTab(tabId) {
    const isFullPage = tabId === 'bureau' || tabId === 'student' || tabId === 'hapi' || tabId === 'mic';
    document.body.classList.toggle('bureau-active', isFullPage);
    
    const nav = document.getElementById('navbar');
    const footer = document.querySelector('footer');
    if (nav) nav.style.display = (tabId === 'student' || tabId === 'mic') ? 'none' : 'flex';
  ...
  if (activeTab) {
    ...
    document.body.classList.toggle('bureau-active', tabId === 'bureau' || tabId === 'student' || tabId === 'hapi');
  }
}
